      ...
      <section className="relative min-h-screen flex flex-col justify-center overflow-hidden bg-gradient-to-br from-blue-600 via-purple-600 to-purple-700">
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex-1 flex flex-col justify-center pt-28">
          ...
          >
            ...
            <motion.p
              className="text-lg md:text-xl text-white/90 mb-12 max-w-6xl mx-auto leading-relaxed"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, delay: 0.5 }}
            >
             We design and deliver next-generation <span className="font-bold text-yellow-400">AI solutions</span>, from intelligent business applications to enterprise-grade <span className="font-bold text-yellow-400">intelligent automation ecosystems</span>, crafted to streamline processes, improve <span className="font-bold text-yellow-400">operational efficiency</span>, and generate measurable <span className="font-bold text-yellow-400">business impact</span>. Our service domains include <span className="font-bold text-yellow-400">AIMA</span> (Artificial Intelligence, Machine Learning & Agents), <span className="font-bold text-yellow-400">AIDA</span> (AI & Data Analysis), <span className="font-bold text-yellow-400">VisionAI</span> (Chatbots & Computer Vision), <span className="font-bold text-yellow-400">CyTI</span> (Cybersecurity & IoT), <span className="font-bold text-yellow-400">Cubebotics</span> (Embedded Systems & IoT), <span className="font-bold text-yellow-400">DCE</span> (Data & Cloud Engineering), and <span className="font-bold text-yellow-400">Tech Solution</span> (Full-Stack Development & Consulting). By combining <span className="font-bold text-yellow-400">AI</span>, <span className="font-bold text-yellow-400">IoT</span>, <span className="font-bold text-yellow-400">cloud computing</span>, <span className="font-bold text-yellow-400">data engineering</span>, and <span className="font-bold text-yellow-400">embedded systems</span>, we deliver end-to-end <span className="font-bold text-yellow-400">digital transformation</span> services that enable organizations to become agile, innovative, and future-ready. Learn more in our AI Ethics Guide.
            </motion.p>
