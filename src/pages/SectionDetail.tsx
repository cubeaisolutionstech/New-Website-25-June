...
const SectionDetail = () => {
  const { exploreId, sectionId } = useParams();
    ...
    'aima': {
      'industry-40': {
        ...
        whatWeDo: {
          title: 'What We Do',
          icon: Target,
          content: 'We revolutionize manufacturing through intelligent automation, predictive maintenance, and real-time optimization. Our Industry 4.0 & 5.0 solutions integrate AI, IoT, and advanced analytics to create fully autonomous production systems that adapt and learn from operational data.',
          features: ['Smart Manufacturing', 'Predictive Maintenance', 'Quality Control', 'Real-time Optimization']
        },
        solutions: {
          title: 'Solutions',
          icon: Lightbulb,
          content: 'Our comprehensive suite includes AI-powered production planning, intelligent supply chain management, automated quality inspection systems, and predictive analytics platforms that reduce downtime by up to 40% and increase overall equipment effectiveness.',
          features: ['AI Production Planning', 'Supply Chain Intelligence', 'Automated Inspection', 'Predictive Analytics']
        },
        trending: {
          title: 'Trending',
          icon: TrendingUp,
          content: 'Digital twins, edge computing, and collaborative robots are transforming manufacturing. We leverage these cutting-edge technologies to create smart factories that are more efficient, sustainable, and responsive to market demands.',
          features: ['Digital Twins', 'Edge Computing', 'Collaborative Robots', 'Sustainable Manufacturing']
        },
        futurePlans: {
          title: 'Future Plans',
          icon: Rocket,
          content: 'We are developing next-generation autonomous manufacturing systems with self-healing capabilities, quantum-enhanced optimization algorithms, and fully integrated sustainability metrics that will define Industry 6.0.',
    ...
    'city': {
      'iot-services': {
        ...
        whatWeDo: {
          title: 'What We Do',
          icon: Target,
          content: 'We create comprehensive Internet of Things solutions that connect devices, sensors, and systems to create intelligent ecosystems for smart cities, industrial automation, and connected infrastructure.',
          features: ['Device Management', 'Sensor Networks', 'Data Collection', 'System Integration']
        },
        solutions: {
          title: 'Solutions',
          icon: Lightbulb,
          content: 'Our IoT platform provides real-time monitoring, predictive analytics, automated responses, and seamless connectivity across diverse device ecosystems with enterprise-grade security.',
          features: ['Real-time Monitoring', 'Predictive Analytics', 'Automated Responses', 'Secure Connectivity']
        },
        trending: {
          title: 'Trending',
          icon: TrendingUp,
          content: '5G connectivity, edge AI, and digital twins are revolutionizing IoT applications. We integrate these technologies to create more responsive and intelligent connected systems.',
          features: ['5G Integration', 'Edge AI', 'Digital Twins', 'Smart Analytics']
        },
        futurePlans: {
          title: 'Future Plans',
          icon: Rocket,
          content: 'We are developing autonomous IoT networks that can self-configure, self-heal, and adapt to changing conditions while maintaining optimal performance and security.',
      ...
      'auto-sizing': {
        ...
        whatWeDo: {
          title: 'What We Do',
          icon: Target,
          content: 'We develop intelligent auto-scaling solutions that automatically adjust system resources based on demand patterns, usage analytics, and performance metrics to optimize efficiency and reduce costs.',
          features: ['Resource Optimization', 'Demand Prediction', 'Performance Monitoring', 'Cost Reduction']
        },
        solutions: {
          title: 'Solutions',
          icon: Lightbulb,
          content: 'Our auto-sizing platform includes predictive scaling algorithms, real-time resource allocation, intelligent load balancing, and comprehensive analytics for optimal system performance.',
          features: ['Predictive Scaling', 'Resource Allocation', 'Load Balancing', 'Performance Analytics']
        },
        trending: {
          title: 'Trending',
          icon: TrendingUp,
          content: 'Serverless computing, container orchestration, and AI-driven resource management are transforming how systems scale. We leverage these technologies for optimal resource utilization.',
          features: ['Serverless Computing', 'Container Orchestration', 'AI Resource Management', 'Multi-Cloud Scaling']
        },
        futurePlans: {
          title: 'Future Plans',
          icon: Rocket,
          content: 'We are developing quantum-enhanced optimization algorithms and neural network-based prediction models that will enable unprecedented accuracy in resource scaling and management.',
    ...
    'cubebotics': {
      'embedded-iot': {
        ...
        solutions: {
          title: 'Solutions',
          icon: Lightbulb,
          content: 'Our embedded and IoT solutions include low-power device design, secure communication protocols, edge computing capabilities, and integration with cloud platforms for scalable deployments.',
          features: ['Low-Power Design', 'Secure Protocols', 'Edge Computing', 'Cloud Integration']
        },
        trending: {
          title: 'Trending',
          icon: TrendingUp,
          content: 'Edge AI, low-power IoT networks, and 5G-enabled devices are driving the future of embedded systems. We leverage these trends to deliver cutting-edge solutions.',
          features: ['Edge AI', 'Low-Power IoT', '5G Connectivity', 'Smart Sensors']
        },
        futurePlans: {
          title: 'Future Plans',
          icon: Rocket,
          content: 'We are developing next-generation embedded systems with AI-driven optimization, self-configuring IoT networks, and advanced energy harvesting for sustainable deployments.',
      ...
      'drone-tech': {
        ...
        whatWeDo: {
          title: 'What We Do',
          icon: Target,
          content: 'We create advanced drone technology solutions for applications like surveillance, mapping, and industrial inspection, leveraging AI and high-precision sensors.',
          features: ['AI-Powered Navigation', 'High-Precision Sensors', 'Real-time Data', 'Autonomous Flight']
        },
        solutions: {
          title: 'Solutions',
          icon: Lightbulb,
          content: 'Our drone solutions include autonomous flight systems, real-time data analytics, high-resolution imaging, and secure data transmission for various industrial use cases.',
          features: ['Autonomous Navigation', 'Data Analytics', 'High-Resolution Imaging', 'Secure Transmission']
        },
        trending: {
          title: 'Trending',
          icon: TrendingUp,
          content: 'Swarm intelligence, AI-based image processing, and drone-as-a-service models are shaping the future of drone technology. We integrate these advancements for superior performance.',
          features: ['Swarm Intelligence', 'AI Image Processing', 'Drone-as-a-Service', 'Precision Mapping']
        },
        futurePlans: {
          title: 'Future Plans',
          icon: Rocket,
          content: 'We are advancing drone technology with quantum-enhanced navigation, autonomous swarm coordination, and eco-friendly propulsion systems for sustainable operations.',
    ...
    'vision-ai': {
      ...
      'computer-vision': {
        ...
        whatWeDo: {
          title: 'What We Do',
          icon: Target,
          content: 'We build advanced computer vision applications for image recognition, object detection, and real-time analysis across industries.',
          features: ['Image Recognition', 'Object Detection', 'Real-time Analysis', 'Facial Recognition']
        },
        solutions: {
          title: 'Solutions',
          icon: Lightbulb,
          content: 'Our computer vision solutions include automated quality inspection, surveillance systems, medical imaging analysis, and augmented reality applications.',
          features: ['Quality Inspection', 'Surveillance Systems', 'Medical Imaging', 'Augmented Reality']
        },
        trending: {
          title: 'Trending',
          icon: TrendingUp,
          content: 'Edge-based vision processing, 3D modeling, and AI-driven anomaly detection are leading trends. We integrate these for cutting-edge vision applications.',
          features: ['Edge Processing', '3D Modeling', 'Anomaly Detection', 'Real-time Vision']
        },
        futurePlans: {
          title: 'Future Plans',
          icon: Rocket,
          content: 'We are developing quantum-enhanced vision algorithms, neural network-based scene understanding, and autonomous vision systems for future applications.',
  ...
  const section = sectionData[exploreId]?.[sectionId];
              ...
              >
                <div className="bg-slate-800/80 backdrop-blur-xl rounded-3xl p-10 hover:bg-slate-700/80 transition-all duration-500 border border-purple-500/30 hover:border-purple-400/50 hover:shadow-2xl h-full">
                  <div className="flex items-center mb-8">
                    <div className={`w-16 h-16 rounded-2xl bg-gradient-to-r ${section.color} flex items-center justify-center mr-6 group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
